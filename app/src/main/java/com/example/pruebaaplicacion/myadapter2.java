...
public class myadapter2 extends FirebaseRecyclerAdapter<model2, myadapter2.myviewholder>
{
    ...
    @Override
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull final model2 model) {
        ...
        holder.img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.wrapper,new descfragment2(model.getNombre(),model.getDireccion(),model.getHoras(),model.getSurl())).addToBackStack(null).commit();
            }
        });
    }
