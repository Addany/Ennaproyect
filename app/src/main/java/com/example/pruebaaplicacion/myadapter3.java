...
public class myadapter3 extends FirebaseRecyclerAdapter<model3, myadapter3.myviewholder>
{
    ...
    @Override
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull final model3 model) {
        ...
        holder.img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.wrapper,new descfragment3(model.getNombre(),model.getDireccion(),model.getHoras(),model.getSurl())).addToBackStack(null).commit();
            }
        });
    }
