...
public class myadapter5 extends FirebaseRecyclerAdapter<model5, myadapter5.myviewholder>
{
    ...
    @Override
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull final model5 model) {
        ...
        holder.img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.wrapper,new descfragment5(model.getNombre(),model.getDireccion(),model.getHoras(),model.getSurl())).addToBackStack(null).commit();
            }
        });
    }
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerowdesign5,parent,false);
